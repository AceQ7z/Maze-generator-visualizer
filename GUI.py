...
box = [r1, r2, r3, r4, r5,r6,r7,r8,r9,r10,r11,r12,r13,r14,r15,r16,r17,r18,r19,r20,r21,r22,r23,r24,r25]
...
while RUN:
    ...
    #Wall drawing
    if row - pre_row == -1:
        pygame.draw.line(window, (0,0,0), (pre_col*30+1,(pre_row*30)-1), ((pre_col*30)+28,(pre_row*30)-1),2)
    if row - pre_row == 1:
        pygame.draw.line(window,(0,0,0), (pre_col*30+1,(pre_row*30)+29), ((pre_col*30)+28,(pre_row*30)+29),2)
    if col - pre_col == 1:
        pygame.draw.line(window,(0,0,0), ((pre_col*30)+29,pre_row*30+1), ((pre_col*30)+29, (pre_row*30)+28) ,2)
    if col-pre_col == -1:
        pygame.draw.line(window, (0,0,0), ((pre_col*30)-1, pre_row*30+1), ((pre_col*30)-1,(pre_row*30)+28),2)

    window.blit(start, (0, 0))

    pygame.draw.rect(end, (255, 255, 255), end.get_rect(), 1)
    window.blit(end, ((len(r1)-1) * 30, (len(box)-1) * 30))
...
while SEARCH:
    ...
    for path in range(len(gen_pathway)):
        gen_prerow = pre_pathway[path][0]
        gen_precol = pre_pathway[path][1]
        gen_row = gen_pathway[path][0]
        gen_col = gen_pathway[path][1]

        window.blit(cell, (gen_col * 30, gen_row * 30))

        if gen_row - gen_prerow == -1:
            pygame.draw.line(window, (0, 0, 0), (gen_precol * 30 + 1, (gen_prerow * 30) - 1),
                             ((gen_precol * 30) + 28, (gen_prerow * 30) - 1), 2)
        if gen_row - gen_prerow == 1:
            pygame.draw.line(window, (0, 0, 0), (gen_precol * 30 + 1, (gen_prerow * 30) + 29),
                             ((gen_precol * 30) + 28, (gen_prerow * 30) + 29), 2)
        if gen_col - gen_precol == 1:
            pygame.draw.line(window, (0, 0, 0), ((gen_precol * 30) + 29, gen_prerow * 30 + 1),
                             ((gen_precol * 30) + 29, (gen_prerow * 30) + 28), 2)
        if gen_col - gen_precol == -1:
            pygame.draw.line(window, (0, 0, 0), ((gen_precol * 30) - 1, gen_prerow * 30 + 1),
                             ((gen_precol * 30) - 1, (gen_prerow * 30) + 28), 2)
